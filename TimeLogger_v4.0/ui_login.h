...
public:
    ...
    void setupUi(QMainWindow *Login)
    {
        ...
        Login->resize(302, 455);
        Login->setMinimumSize(QSize(302, 455));
        Login->setMaximumSize(QSize(302, 455));
...
"}"));
        ...
        stackedWidget->setMinimumSize(QSize(302, 241));
        stackedWidget->setMaximumSize(QSize(302, 241));
