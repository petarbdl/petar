...
public:
    ...
    void setupUi(QWidget *TimeStatus)
    {
        ...
        TimeStatus->resize(1299, 866);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(TimeStatus->sizePolicy().hasHeightForWidth());
        TimeStatus->setSizePolicy(sizePolicy);
        TimeStatus->setMinimumSize(QSize(1299, 866));
...
"}"));
        ...
        sizePolicy1.setHeightForWidth(labelFirstDay->sizePolicy().hasHeightForWidth());
        labelFirstDay->setSizePolicy(sizePolicy1);
        ...
        label_4->setMinimumSize(QSize(7, 0));
        QFont font3;
        ...
        sizePolicy1.setHeightForWidth(labelLastDay->sizePolicy().hasHeightForWidth());
        labelLastDay->setSizePolicy(sizePolicy1);
...
"}"));
        ...
        buttonLogout = new QPushButton(TimeStatus);
        ...
        buttonLogout->setMaximumSize(QSize(120, 30));
        QFont font7;
...
"}"));
        ...
        sizePolicy2.setHeightForWidth(buttonAddTime->sizePolicy().hasHeightForWidth());
        buttonAddTime->setSizePolicy(sizePolicy2);
        buttonAddTime->setMinimumSize(QSize(120, 30));
        buttonAddTime->setMaximumSize(QSize(120, 30));
        buttonAddTime->setFont(font7);
...
"}"));
    ...
    void retranslateUi(QWidget *TimeStatus)
    {
        ...
        label_4->setText(QCoreApplication::translate("TimeStatus", "-", nullptr));
        ...
        buttonLogout->setText(QCoreApplication::translate("TimeStatus", "LOGOUT", nullptr));
