...
"}"));
        ...
        sizePolicy1.setHeightForWidth(buttonAssignProject->sizePolicy().hasHeightForWidth());
        buttonAssignProject->setSizePolicy(sizePolicy1);
        buttonAssignProject->setMinimumSize(QSize(140, 30));
        QFont font8;
