...
void GetUserReport::setReportDetails()
{
    ...
    MyDatabase::instance()->getAllUserReportsCountQuery(ui->comboBoxPerson->currentText(),ui->comboBoxProject->currentText());
    ...
    MyDatabase::instance()->getAllUserReportsQuery(ui->comboBoxPerson->currentText(),ui->comboBoxProject->currentText());
