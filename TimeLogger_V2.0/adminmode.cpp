    ...
    ui(new Ui::AdminMode)
{
    ...
    connect(&m_addTimeDialog, SIGNAL(dataUpdatedAdmin()), this, SLOT(onDataUpdatedAdmin()));
    ...
    connect(MyDatabase::instance(), SIGNAL(addButtonsAdmin(int)), this, SLOT(onAddButtons(int)));
...
void AdminMode::onAddButtons(int m)
{
...
void AdminMode::onButtonEditClicked(Buttons *button)
{
    QModelIndex index;
...
void AdminMode::onButtonDeleteClicked(Buttons *button)
{
    QModelIndex index;
        index=button->getIndex();
        QString dateString;
...
void AdminMode::on_pushButtonAssignProject_clicked()
{
