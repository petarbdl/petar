...
"}"));
        ...
        sizePolicy2.setHeightForWidth(labelFirstDay->sizePolicy().hasHeightForWidth());
        labelFirstDay->setSizePolicy(sizePolicy2);
        labelFirstDay->setMinimumSize(QSize(150, 0));
        QFont font2;
        font2.setPointSize(14);
        font2.setBold(true);
        font2.setWeight(75);
        labelFirstDay->setFont(font2);
        labelFirstDay->setLayoutDirection(Qt::LeftToRight);
        labelFirstDay->setAlignment(Qt::AlignCenter);

        horizontalLayout->addWidget(labelFirstDay);

        label_5 = new QLabel(AdminMode);
        ...
        sizePolicy2.setHeightForWidth(labelLastDay->sizePolicy().hasHeightForWidth());
        labelLastDay->setSizePolicy(sizePolicy2);
        labelLastDay->setMinimumSize(QSize(150, 0));
        labelLastDay->setFont(font2);
        labelLastDay->setLayoutDirection(Qt::LeftToRight);
        labelLastDay->setAlignment(Qt::AlignCenter);
...
"}"));
        ...
        sizePolicy3.setHeightForWidth(labelHours->sizePolicy().hasHeightForWidth());
        labelHours->setSizePolicy(sizePolicy3);
        labelHours->setMinimumSize(QSize(36, 0));
        QFont font6;
        font6.setPointSize(20);
        font6.setBold(true);
        font6.setWeight(75);
        labelHours->setFont(font6);
        ...
        buttonLogout = new QPushButton(AdminMode);
...
"}"));
        ...
        verticalLayout_2->addWidget(buttonLogout);

        buttonAssignProject = new QPushButton(AdminMode);
        buttonAssignProject->setObjectName(QString::fromUtf8("buttonAssignProject"));
        sizePolicy3.setHeightForWidth(buttonAssignProject->sizePolicy().hasHeightForWidth());
        buttonAssignProject->setSizePolicy(sizePolicy3);
        buttonAssignProject->setMinimumSize(QSize(120, 30));
        QFont font8;
        font8.setFamily(QString::fromUtf8("MS Shell Dlg 2"));
        font8.setPointSize(9);
        font8.setBold(true);
        font8.setWeight(75);
        buttonAssignProject->setFont(font8);
...
""));
        ...
        buttonGetReport->setMinimumSize(QSize(120, 30));
        buttonGetReport->setFont(font8);
...
""));
        ...
        sizePolicy4.setHeightForWidth(tableWidgetProjectDetails->sizePolicy().hasHeightForWidth());
        tableWidgetProjectDetails->setSizePolicy(sizePolicy4);
...
"}"));
        ...
        sizePolicy4.setHeightForWidth(tableWidgetReportDetails->sizePolicy().hasHeightForWidth());
        tableWidgetReportDetails->setSizePolicy(sizePolicy4);
...
""));
    ...
    void retranslateUi(QWidget *AdminMode)
    {
        ...
        label_5->setText(QCoreApplication::translate("AdminMode", "-", nullptr));
        ...
        buttonLogout->setText(QCoreApplication::translate("AdminMode", "LOGOUT", nullptr));
