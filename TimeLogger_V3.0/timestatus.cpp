    ...
    ui(new Ui::TimeStatus)
{
    ...
    connect(MyDatabase::instance(), SIGNAL(addToolTip(int)), this, SLOT(onAddToolTip(int)));
...
void TimeStatus::onAddToolTip(int m)
{
    ui->tableWidgetReportDetails->itemAt(m,3)->setToolTip("Hi 1");
}
